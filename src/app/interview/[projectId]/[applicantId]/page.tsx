...
export default async function ApplicantDetailPage({ params }: { params: Promise<{ projectId: string; applicantId: string }> }) {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 overflow-hidden">
        <InterviewDetailClient projectId={Number(projectId)} applicantId={Number(applicantId)} />
      </div>
    </div>
  );
}