'use client';
import SelectModal from '@/components/ui/SelectModal'; // 1. 임포트 확인!
...
export default function HomeOff({ title, status, dateRange, applicantCount }: HomeOffProps) {
  // 1. 메뉴 열림 상태 관리
  ...
  return (
    ...
    >
      <h2
        className="absolute top-[16px] left-[25px] w-[160px] h-[22px] text-subtitle-sb whitespace-nowrap truncate transition-colors duration-200
      ...
      <div className="absolute top-[42px] left-[25px] flex flex-col">
        <p
          className="text-body-sm mb-[2px] transition-colors duration-200
                      text-gray-200 group-hover:text-gray-300 group-active:text-gray-400"
        >
          {status}
        </p>
        ...
        <p
          className="text-subtitle-sm-rg mb-[16px] transition-colors duration-200
                      text-gray-200 group-hover:text-gray-300 group-active:text-gray-400"
        >
          {dateRange}
        </p>
        ...
        <p
          className="text-body-rg transition-colors duration-200
                      text-gray-200 group-hover:text-gray-300 group-active:text-gray-400"
        >
