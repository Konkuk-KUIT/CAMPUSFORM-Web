...
export default function HomeOn({ title, status, dateRange, applicantCount }: HomeOnProps) {
  ...
  return (
    <div className="relative w-[343px] h-[130px] bg-white border border-gray-100 rounded-[10px] overflow-hidden hover:bg-blue-100 active:bg-blue-200">
      ...
      <div className="absolute top-[42px] left-[25px] flex flex-col">
        <p className="text-body-sm text-gray-600 mb-[2px]">{status}</p>

        <p className="text-subtitle-sm-rg text-gray-400 mb-[16px]">{dateRange}</p>
